...
import { BarChart3, Bot, Download, MessageSquare, Send, Settings, Users } from "lucide-react";
...
export default function BotAdminPage() {
  ...
  const { data: botStats, isLoading: statsLoading } = api.telegramBot.getBotStats.useQuery();
        ...
        <Tabs defaultValue="stats" className="space-y-6">
          ...
          <TabsContent value="stats" className="space-y-6">
            <div className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-4">
              ...
              <Card>
                <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                  <CardTitle className="font-medium text-sm">{t('bot_downloads')}</CardTitle>
              ...
              <Card>
                <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                  <CardTitle className="font-medium text-sm">{t('bot_conversion')}</CardTitle>
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                ...
                <div className="flex items-center justify-between">
                  <span className="font-medium text-sm">{t('webhook_url')}</span>
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                <div className="space-y-2">
                  <label className="font-medium text-sm">{t('webhook_url')}</label>
                  <Input 
                ...
                <div className="space-y-3">
                  <div className="flex items-center justify-between p-3 border rounded-lg">
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">{t('start_command_description')}</p>
                    </div>
                  </div>
                  <div className="flex items-center justify-between p-3 border rounded-lg">
                    <div>
                      <code className="font-mono">/plugins</code>
                      <p className="text-sm text-muted-foreground">{t('plugins_command_description')}</p>
                    </div>
                  </div>
                  <div className="flex items-center justify-between p-3 border rounded-lg">
                    <div>
                      <code className="font-mono">/search &lt;query&gt;</code>
                      <p className="text-sm text-muted-foreground">{t('search_command_description')}</p>
                    </div>
                  </div>
                  <div className="flex items-center justify-between p-3 border rounded-lg">
                    <div>
                      <code className="font-mono">/help</code>
                      <p className="text-sm text-muted-foreground">{t('help_command_description')}</p>
                    </div>
                  </div>
                </div>
              </CardContent>
          ...
          <TabsContent value="test" className="space-y-6">
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  {t('test_links_description')}
                </CardDescription>
              </CardHeader>
              <CardContent className="space-y-3">
                <div className="space-y-2">
                  <label className="text-sm font-medium">{t('start_command_test')}</label>
                  <code className="block p-2 bg-muted rounded text-sm">
                    https://t.me/exteragram_plugins_bot?start=test
                  </code>
                </div>
                <div className="space-y-2">
                  <label className="text-sm font-medium">{t('plugin_test')}</label>
                  <code className="block p-2 bg-muted rounded text-sm">
          ...
          <TabsContent value="broadcast" className="space-y-6">
            <Card>
              ...
              <CardContent className="space-y-4">
                <div className="space-y-2">
                  <label className="text-sm font-medium">{t('broadcast_message')}</label>
                  <Textarea
