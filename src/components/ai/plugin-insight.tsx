	...
	return (
		<Dialog open={open} onOpenChange={setOpen}>
			<DialogTrigger asChild>
				<Button
					variant="outline"
					className="press-scale min-h-11 gap-2 border-contrast/20 bg-contrast/5 hover:bg-contrast/10"
				>
			...
			<DialogContent className="sm:max-w-2xl">
				...
				{isLoading && (
					<div className="flex min-h-52 flex-col items-center justify-center gap-3 rounded-2xl border bg-surface p-6 text-center">
				...
				{data?.available && (
					<div className="space-y-4">
						<div className="rounded-2xl border border-primary/20 bg-linear-to-br from-primary/10 via-card to-card p-4">
						...
						<div className="grid gap-3 sm:grid-cols-2">
							<section className="rounded-2xl border bg-card p-4">
								...
								<InsightList items={data.bestFor} icon={CheckCircle2} />
							</section>
							<section className="rounded-2xl border bg-card p-4">
								<h3 className="mb-3 flex items-center gap-2 font-semibold text-sm">
								...
								<InsightList items={data.requirements} icon={Wrench} />
							</section>
							<section className="rounded-2xl border bg-card p-4">
								<h3 className="mb-3 flex items-center gap-2 font-semibold text-sm">
								...
								<InsightList items={data.caveats} icon={TriangleAlert} />
							</section>
							<section className="rounded-2xl border bg-card p-4">
								<h3 className="mb-3 flex items-center gap-2 font-semibold text-sm">
